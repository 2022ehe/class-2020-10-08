...
draws2 <- draws %>%
  filter(state %in% c('North Carolina', 'Virginia'))

ggplot(draws2, aes(x = trump_share, fill = state)) + 
  geom_density(alpha = 0.7) + 
  facet_wrap(~state) + 
  theme_classic() + 
  labs(title = 'Estimated Trump Vote Share in North Carolina and Virginia',
